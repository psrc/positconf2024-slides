...
<!--
![](https://posit.co/wp-content/themes/Posit/assets/images/posit-logo-2024.svg){style="display: flex; justify-content: center; width: 25%; margin: 2rem auto;"}
-->

:::: columns
::: {.column width="40%"}

![](https://posit.co/wp-content/themes/Posit/assets/images/posit-logo-2024.svg){style="display: flex; justify-content: center; width: 50%; margin: 2rem auto;"}
...
# Sessions {background-image="https://posit.co/wp-content/uploads/2024/02/confhero-abstract.png" background-opacity=".5"}
...
All graphics and Posit Conference hoto borrowed and sourced from [Posit.co](https://posit.co/conference/)
